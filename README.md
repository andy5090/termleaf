...
Desktop and mobile applications are developed in the private
`termleaf-apps` repository. The subscription and storage service is developed
in the private `termleaf-cloud` repository. This public repository contains the
terminal application, shared Rust core, language assets and website. Client and
server configuration, credentials and deployment settings belong in the private
repositories. The applications consume a pinned revision of this public core.
